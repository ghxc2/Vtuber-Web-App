...
app.get('/error', async (req, res) => {
    res.send("Please Login Using this <a href='https://discord.com/oauth2/authorize?client_id=1468061028008067174&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A1500%2Fapi%2Fauth%2Fdiscord%2Fredirect&scope=identify+guilds+connections+email+guilds.join+gdm.join'>link</a>")
})
